...
async function initSchema(client) {
  ...
  if (client && client.execute) {
    ...
    console.log('[Turso] Table "quotes" ready');
    console.log('[Turso] Table "scrapes" ready');
    console.log('[Turso] Pattern tables ready');
    console.log('[Turso] All required tables verified ✅');
    return;
  }
