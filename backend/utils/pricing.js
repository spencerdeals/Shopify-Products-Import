...
function computePricing(opts = {}) {
  ...
  const duty = Number(itemPriceUSD) * (Number(dutyRatePct) / 100);
  const landed = Number(itemPriceUSD) + njTax + freightRes.freight + fixedFeesUSD + duty;
...
module.exports = { computeFreight, computePricing, round2 };
