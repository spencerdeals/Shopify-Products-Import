...
module.exports = function devTools() {
  ...
  // Version info (Railway exposes these when connected to GitHub)
  ...
  // Simple in-app test page (no CORS, no external tools)
...
<small>This page calls your server from the same origin (no CORS problems). Nothing is stored on your Mac.</small>
